// Copied from https://github.com/shadcn/ui/blob/main/components/dropdown-menu.tsx
...
// Extend props to include 'inset?: boolean'
...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "focus:bg-accent data-[state=open]:bg-accent flex cursor-default items-center rounded-sm px-2 py-1.5 text-sm font-medium outline-none select-none",
      inset && "pl-8",
      className,
    )}
    {...props}
